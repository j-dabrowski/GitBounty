            ...
            <div>
              ...
              <div className="flex justify-center items-center">
                <div className="flex justify-center items-center h-screen p-10">
                  <Link
                    href="/repo-owner"
                    className="box z-10 rounded-full overflow-hidden relative w-[400px] h-[400px] bg-black"
                  ></Link>
                </div>
                ...
                <div className="flex">
                  <Link
                    href="/developer"
                    className="box2 rounded-full overflow-hidden relative w-[400px] h-[400px] bg-black"
                  ></Link>
                </div>
              </div>
            </div>
